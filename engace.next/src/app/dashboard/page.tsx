...
import { WordRotate } from "@/components/system/text/word-rotate-text";
          ...
          <motion.div
            ...
            >
              <motion.span
                ...
                className="w-2 h-2 rounded-full bg-blue-800 mr-2 dark:bg-white"
              />
              <span className="text-sm font-medium bg-gradient-to-r from-blue-800 to-purple-800 text-transparent bg-clip-text dark:from-blue-200 dark:to-purple-200">
                Hoàn toàn miễn phí
              </span>
            </motion.div>
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="relative ">
                <div className="absolute -rotate-12 -left-10 -top-2 md:flex hidden">
                ...
                <h1 className="text-6xl sm:text-7xl font-black uppercase text-center">
                  <span className="text-black bg-gradient-to-r from-black via-blue-400 to-black/80 text-transparent bg-clip-text dark:from-white dark:to-white/80">Học tiếng Anh</span>
                    <WordRotate
                      className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text m-0"
            ...
            <motion.p
              ...
              whileInView="visible"
              viewport={{ once: true, margin: "-100px" }}
              className="max-w-2xl mx-auto text-gray-600 dark:text-gray-400 font-light"
            >
