          ...
          {features.map((feature) => {
            ...
            return (
                ...
                <div className="relative z-10">
                  <div className={`mb-6 inline-flex items-center justify-center rounded-2xl p-4 bg-gradient-to-br ${feature.gradient}`}>
                ...
                {/* Hover Effects */}
                <div className={`absolute inset-0 z-0 bg-gradient-to-br opacity-0 transition-opacity duration-300 group-hover:opacity-10 dark:group-hover:opacity-20 pointer-events-none ${feature.gradient}`} />
                <div className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r opacity-0 transition-all duration-300 group-hover:opacity-100 ${feature.gradient}`} />
              </button>
            )
          })}
        </div>
