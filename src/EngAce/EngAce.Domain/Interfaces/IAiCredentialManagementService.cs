...
public interface IAiCredentialManagementService
{
    ...
    Task<AIServiceCredential> GetCredentialAsync(CancellationToken cancellationToken = default);
    ...
    Task<AiServiceHealthcheckResult> HealthcheckAiServiceAsync(CancellationToken cancellationToken = default);
}
