...
namespace Events
{
    public static class SearchScope
    {
        ...
        public static async Task<string> Search(string apiKey, bool useEnglish, string keyword, string context)
        {
            ...
            {
                promptBuilder.Append("Bạn là từ một điển Anh-Việt siêu ưu việt ứng dụng công nghệ AI vào việc tra cứu. Nhiệm vụ của bạn là giúp tôi giải nghĩa tiếng Anh.");
                ...
                promptBuilder.AppendLine($"- Cung cấp tối thiểu 5 ví dụ về cách áp dụng kèm hoàn cảnh áp dụng của '{keyword}' và một số từ vựng khác có liên quan.");
